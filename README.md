...
| **문서** | 마크다운 편집/프리뷰 · `[[위키링크]]` · 링크 그래프 · **버전 이력(P59)** |
...
| **30** | **3.2.0** | 일지 트리·캘린더·목록·통계 (폴더 · DnD · bulk) | ✅ |
| **31** | **3.3.0-wip** | 문서 버전 관리 (스냅샷 · diff · 복원) | 🔄 |

Phase 31 상세: **P59** 문서 스냅샷 · Diff(줄/단어) · 복원/체크아웃 · 5분 자동 · 수동 버전  
Phase 30 상세: **P58** 폴더/트리 · 캘린더(월/주/일) · 목록 · 통계 · 작성/보기 탭 · bulk · `9b19581`/`23a5c91`  
...
| **일지 트리** | 폴더 · 캘린더 · 목록 · 통계 · bulk (P58) | ✅ 3.2.0 |
| **문서 버전** | 스냅샷 · diff · 복원 · 체크아웃 (P59) | 🔄 3.3.0-wip |
| **DX** | 성능 예산 · 기여/테스트 가이드 | ✅ |
...
| 탭 | 내용 |
|----|------|
| **작성** | Writing-first 에디터만 (날짜 네비 · 저장/내보내기 · 태그 · 주석) |
...
- **v3.2** ✅ — 일지 트리·캘린더·목록·통계 · **3.2.0**
- **v3.3** 🔄 — 문서 버전 관리 (스냅샷 · diff · 복원) · **3.3.0-wip**

## 작업 관리

- 현재 Phase: **Phase 31 진행 중** (v**3.3.0-wip**)
- 진행 중: **P59** 문서 버전 관리
- 완료: Phase 1~30 · P58 일지 관리 확장
...
**Folio** — 프로젝트의 기록, 한 곳에서. · v3.3.0-wip
