...
Folio 서비스 장애 시 대응 절차. (P22 · **v2.0 갱신**)

### 에스컬레이션 (요약)

| 단계 | 시간 | 행동 |
|------|------|------|
| T+5m | 인지 | health · runtime · 로그 |
| T+15m | 완화 | 저장 모드 local 안내 · 롤백 검토 |
| T+30m | 복구 | Promote/이전 이미지 · 통지 |
| T+24h | 사후 | postmortem · VERSION/INCIDENT 갱신 |

시크릿 유출 시: 해당 키 즉시 로테이션 · webhook/PAT 재발급 · 공개 이슈 금지.
