...
**v2.1 배포 전:** `npm run test` · CSP(`next.config.ts`) · [MIGRATION.md](../MIGRATION.md) · 저장 관측 env 확인. 태그 `v2.1.0` 푸시 시 Release 워크플로가 노트를 생성합니다.
...
| `FOLIO_VERSION` | `2.1.0` | Dockerfile ARG / compose |
