...
| ID | 요약 | 노트 |
|----|------|------|
| P54 | 데이터 마이그레이션 도구 | Phase 26 · 2.8.0-wip |

## Phase 26 계획

| ID | 요약 | 노트 |
|----|------|------|
| P54 | 버전 마이그레이션 · SQLite · 충돌 · 검증 UI | 🔄 migrate runner · rollback · sql.js |
...
| 마이그레이션 | 버전 스크립트 · SQLite · 롤백 · 검증 | 🔄 2.8.0-wip (P54) |
| DX | 성능 예산 · 기여 가이드 | ✅ |
