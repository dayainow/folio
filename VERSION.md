...
| Phase | Phase 29 진행 중 |
| 진행 중 | **P57** 모바일 네이티브 앱 |
| 다음 | Phase 29 완료 · 3.1.0 정식 |
| 이어가기 | `origin/main` @ v3.1.0-wip |
...
| ID | 요약 | 노트 |
|----|------|------|
| P57 | 모바일 네이티브 앱 (PWA · 제스처 · 오프라인 · 탭바) | Phase 29 · 3.1.0-wip |

## Phase 29 계획

| ID | 요약 | 노트 |
|----|------|------|
| P57 | PWA 고도화 · 제스처 · 오프라인 우선 · 탭바 · 풀스크린 | 🔄 진행 중 |
| — | 3.1.0 정식 | Phase 29 완료 시 |
