...
| 버전 | **3.2.0-wip** |
| Phase | Phase 30 진행 중 |
| 진행 중 | **P58** 일지 트리·캘린더·목록·통계 |
| 다음 | Phase 30 완료 · 3.2.0 정식 |
| 이어가기 | `origin/main` @ v3.2.0-wip |
...
| ID | 요약 | 노트 |
|----|------|------|
| P58 | 일지 트리·캘린더·목록·통계 (폴더 · DnD · bulk · 경로) | Phase 30 · 3.2.0-wip |

## Phase 30 계획

| ID | 요약 | 노트 |
|----|------|------|
| P58 | 폴더 CRUD · 트리 · 캘린더/목록/통계 · bulk · `/journal/...` | 🔄 진행 중 |
| — | 3.2.0 정식 | Phase 30 완료 시 |
...
| — | 3.1.0 정식 | ⏭ Phase 30로 진행 (3.2.0-wip) |
...
| 일지 트리 | 폴더 · DnD · bulk · 경로 · 심볼릭 참조 | 🔄 3.2.0-wip (P58) |
| DX | 성능 예산 · 기여 가이드 | ✅ |
...
### 3.2.0-wip — 2026-08-05 (Phase 30 P58 일지 트리·캘린더)

- 버전 **3.2.0-wip** · Phase 30 시작
- 일지 폴더/트리 (`journal-tree.ts`) · 기본 구조(미분류/날짜/프로젝트/태그)
- 사이드바 트리 뷰 · 접기/펼치기 · 우클릭 · DnD 이동
- bulk 선택(체크·Shift) · 이동/태그/보관/내보내기/삭제
- 메타: `folder_id` · `parent_id` · `status` · `projectId` · `importance`
- 경로 `/journal/{folder}/{date}` · 심볼릭 다중 폴더 참조
- 스키마 마이그레이션 v4
- **캘린더/목록/통계 확장**: `calendar-engine` · 월·주·일 뷰 · DnD 날짜 변경
- 일지 탭 **작성 / 보기** 분리 · 보기 하위(캘린더·목록·트리·통계)
- streak · 시간대 히트맵 · 태그 빈도
