...
| P60 | 내보내기/공유 고도화 (PDF·HTML·공유링크·임베드·클라우드) | (이번 커밋) |

## 진행 중

| ID | 요약 | 노트 |
|----|------|------|
| P60 | PDF · HTML · MD frontmatter · 공유 링크 · 임베드 · Storage 백업 | Phase 32 · docs/EXPORT-SHARE.md |

## Phase 32 계획 (진행 중)

| ID | 요약 | 노트 |
|----|------|------|
| P60 | 내보내기/공유 고도화 | ✅ WIP · docs/EXPORT-SHARE.md |
| — | 3.4.0 정식 | 예정 |
...
| 내보내기/공유 | PDF · HTML · 공유 링크 · 임베드 · 클라우드 백업 | 🔄 3.4.0-wip (P60) |
| DX | 성능 예산 · 기여 가이드 | ✅ |
...
### 3.4.0-wip — 2026-08-06 (Phase 32 · P60)
