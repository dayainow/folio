...
| 버전 | **3.6.0-wip** |
| Phase | Phase 34 진행 중 |
| 진행 중 | P62 일지 보기/문서 탭 단순화 (P62-1 작성|보기 분리) |
| 다음 | Phase 34 완료 · 3.6.0 정식 |
| 이어가기 | `origin/main` @ v3.6.0-wip |
...
| ID | 요약 | 노트 |
|----|------|------|
| P62 | 일지 보기/문서 탭 단순화 | Phase 34 · 최소 UI |

## Phase 34 계획 (진행 중)

| ID | 요약 | 노트 |
|----|------|------|
| P62 | 일지 보기 · 문서 탭 단순화 | 🔄 WIP |
| — | 3.6.0 정식 | 예정 |
...
| UI 단순화 | 일지 보기 · 문서 탭 최소 UI | 🔄 3.6.0-wip (P62) |
| DX | 성능 예산 · 기여 가이드 | ✅ |
