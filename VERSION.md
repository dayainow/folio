...
| Phase | Phase 17 진행 중 |
| 진행 중 | P45 실시간 협업 고도화 |
| 다음 | Phase 17 완료 · 1.8.0 정식 |
| 이어가기 | `origin/main` @ 1.8.0-wip (P45) |
...
| ID | 요약 | 노트 |
|----|------|------|
| P45 | 실시간 협업 고도화 | Presence 상태 · guest · ACL · 알림 센터 · 초대 링크 |

## Phase 17 계획 (진행 중)

| ID | 요약 | 노트 |
|----|------|------|
| P45 | 실시간 협업 고도화 | 커서/Presence · Yjs 충돌/diff · 역할·ACL · 알림 센터 |
| — | 1.8.0 정식 | Phase 17 완료 예정 |
