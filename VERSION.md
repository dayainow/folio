...
| P50 | 성능 관측 및 자동 최적화 | (본 커밋) |

## 진행 중

| ID | 요약 | 노트 |
|----|------|------|
| P50 | 성능 관측 및 자동 최적화 | Phase 22 · 2.4.0-wip |

## Phase 22 계획

| ID | 요약 | 노트 |
|----|------|------|
| P50 | 성능 관측 · 자동 최적화 | 🔄 Web Vitals · 대시보드 · 알림 · LHCI · 번들 예산 |
...
| 성능 | Web Vitals · 대시보드 · LHCI · 번들 예산 | 🔄 2.4.0-wip (P50) |
| DX | 성능 예산 · 기여 가이드 | ✅ |
