...
| 이어가기 | `origin/main` @ 2.0.0-wip (P46) |
...
| ID | 요약 | 노트 |
|----|------|------|
| P46 | v2.0 기반 정비 | Vitest · 타입 · 문서 · 데드코드 |

## Phase 18 계획 (v2.0 · 진행 중)

| ID | 요약 | 노트 |
|----|------|------|
| P46 | v2.0 기반 정비 | 버전 리셋 · 테스트 인프라 · ARCHITECTURE · 정리 |
| — | 2.0.0 정식 | Phase 18 완료 예정 |

### v2.0 로드맵 (초안)

| 테마 | 목표 |
|------|------|
| 기반 | Vitest CI · 타입 강화 · 문서 정렬 (P46) |
| 저장 | WithFallback 계약 문서화 · 관측성 강화 |
| 협업 | Presence/Yjs 서버 동기화 옵션 |
| DX | 스토리/가이드 · 성능 예산 |
