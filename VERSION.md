...
| P51 | 플러그인/확장 시스템 | (본 커밋) |

## 진행 중

| ID | 요약 | 노트 |
|----|------|------|
| P51 | 플러그인/확장 시스템 | Phase 23 · 2.5.0-wip |

## Phase 23 계획

| ID | 요약 | 노트 |
|----|------|------|
| P51 | 플러그인 · 위젯 · 커스텀 필드 · 마켓 | 🔄 registry · sandbox · marketplace |
...
| 확장 | 플러그인 · 위젯 · 커스텀 필드 · 마켓 | 🔄 2.5.0-wip (P51) |
| DX | 성능 예산 · 기여 가이드 | ✅ |
