...
| ID | 요약 | 노트 |
|----|------|------|
| P61 | 알림 허브 · 인앱 메시지 · 이메일 · rich 푸시 | Phase 33 · docs/NOTIFICATIONS.md |

## Phase 33 계획 (진행 중)

| ID | 요약 | 노트 |
|----|------|------|
| P61 | 알림/메시지 시스템 고도화 | ✅ WIP · docs/NOTIFICATIONS.md |
| — | 3.5.0 정식 | 예정 |
...
| 알림/메시지 | 허브 · 인앱 메시지 · 이메일 · rich 푸시 | 🔄 3.5.0-wip (P61) |
| DX | 성능 예산 · 기여 가이드 | ✅ |
...
- **P61** 알림/메시지 시스템 고도화
  - 알림 허브 (`notification-hub.tsx`) · 그룹/필터/읽음
  - 인앱 메시지 채널 (문서/프로젝트) · 읽음 · 반응 · 검색
  - 이메일 중요 알림 · 일일/주간 요약 · 유형별 구독
  - rich 푸시 (이미지·버튼·그룹/스레드·진동)
