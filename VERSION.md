...
| ID | 요약 | 노트 |
|----|------|------|
| P55 | 접근성/품질 강화 (WCAG · E2E · 온보딩 · 고대비) | Phase 27 · 2.9.0-wip |

## Phase 27 계획

| ID | 요약 | 노트 |
|----|------|------|
| P55 | WCAG AA · Playwright · 커버리지 · 온보딩/팁 · 고대비 | 🔄 진행 중 |
| — | 2.9.0 정식 | Phase 27 완료 시 |
