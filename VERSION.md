...
| P65 | 테마/다크/고대비/커스텀 프리셋·접근성 | — |

## 진행 중

| ID | 요약 | 노트 |
|----|------|------|
| P65 | 테마 · 고대비 · 커스텀 프리셋 · a11y | Phase 37 · docs/THEMES.md |

## Phase 37 계획 (진행 중)

| ID | 요약 | 노트 |
|----|------|------|
| P65 | Light/Dark/System · 프리셋 · AAA 고대비 · 모션 | 🔄 WIP |
| — | 3.9.0 정식 | 예정 |
...
| 테마/접근성 | Light/Dark/System · 고대비 · 커스텀 프리셋 | 🔄 3.9.0-wip (P65) |
| DX | 성능 예산 · 기여 가이드 | ✅ |
