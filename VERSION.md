...
| Phase | Phase 31 진행 중 |
| 진행 중 | **P59** 문서 버전 관리 |
| 다음 | Phase 31 완료 · 3.3.0 정식 |
| 이어가기 | `origin/main` @ v3.3.0-wip |
...
| — | Phase 30 완료 · 3.2.0 정식 릴리즈 | `48958fe` |

## 진행 중

| ID | 요약 | 노트 |
|----|------|------|
| P59 | 문서 버전 관리 (스냅샷 · diff · 복원 · 체크아웃) | Phase 31 · 3.3.0-wip |

## Phase 31 계획

| ID | 요약 | 노트 |
|----|------|------|
| P59 | 스냅샷 · Diff · 복원/체크아웃 · 5분 자동 · UI | 🔄 진행 중 |
...
| — | 3.2.0 정식 | ✅ Phase 30 완료 릴리즈 · `48958fe` |
...
| 일지 트리 | 폴더 · DnD · bulk · 경로 · 심볼릭 참조 · 캘린더 | ✅ 3.2.0 (P58) |
| 문서 버전 | 스냅샷 · diff · 복원 · 체크아웃 · 자동 저장 | 🔄 3.3.0-wip (P59) |
| DX | 성능 예산 · 기여 가이드 | ✅ |
...
### 3.3.0-wip — 2026-08-05 (Phase 31 P59 문서 버전 관리)

- 버전 **3.3.0-wip** · Phase 31 시작
- 문서 스냅샷 (`doc-versions.ts`) · v1.0 / v1.1 자동 부여
- Diff 뷰어 (줄/단어) · 복원 · 새 문서 체크아웃
- 5분 자동 스냅샷 · 수동 버전(메모) · 중요 변경 시 important 버전
- 문서 헤더 버전 드롭다운 · 이력 패널 · Diff 모달

### 3.2.0 — 2026-08-05 (Phase 30 완료)

- 정식 릴리즈 **3.2.0** (일지 관리 확장)
...
- README: Phase 1~30 완료 · 일지 관리 확장 사용법
