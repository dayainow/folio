...
| Phase | Phase 30 완료 |
| 진행 중 | — |
| 다음 | Phase 31 · **P59** 문서 버전 관리 · 3.3.0-wip |
| 이어가기 | `origin/main` @ v3.2.0 |
...
| — | Phase 30 완료 · 3.2.0 정식 릴리즈 | `48958fe` / 마감 본 커밋 |
...
| ID | 요약 | 노트 |
|----|------|------|
| P59 | 스냅샷 · Diff · 복원/체크아웃 · 5분 자동 · UI | ⏭ 다음 (코드 일부 main 반영됨) |
| — | 3.3.0 정식 | Phase 31 완료 시 |
...
| 문서 버전 | 스냅샷 · diff · 복원 · 체크아웃 · 자동 저장 | ⏭ Phase 31 (P59) |
| DX | 성능 예산 · 기여 가이드 | ✅ |
