...
| ID | 요약 | 노트 |
|----|------|------|
| P56 | 실무 편의성 (Quick Capture · 템플릿 · 시간추적 · 북마크 · 단축키) | Phase 28 · 3.0.0-wip |

## Phase 28 계획

| ID | 요약 | 노트 |
|----|------|------|
| P56 | Quick Capture · 템플릿 · Time Tracking · 북마크 · 단축키 | 🔄 진행 중 |
| — | 3.0.0 정식 | Phase 28 완료 시 |
...
| — | 2.9.0 정식 | ⏭ Phase 28로 진행 (3.0.0-wip) |
...
| 실무 편의 | Quick Capture · 템플릿 · 시간추적 · 북마크 | 🔄 3.0.0-wip (P56) |
| DX | 성능 예산 · 기여 가이드 | ✅ |
